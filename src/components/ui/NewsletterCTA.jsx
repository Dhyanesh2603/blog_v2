  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 py-24">
      <motion.div 
        ...
        className="relative overflow-hidden rounded-3xl bg-[var(--color-elevated)] border border-[var(--color-border)] p-12 md:p-16 flex flex-col items-center text-center"
      >
        ...
        <div className="relative z-10 max-w-2xl">
          <h2 className="text-heading-1 text-[var(--color-primary)] mb-6">
            Stay in the loop
          </h2>
          <p className="text-body text-[var(--color-secondary)] mb-10 max-w-lg mx-auto">
