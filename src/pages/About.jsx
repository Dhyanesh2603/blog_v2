  ...
  return (
    <div className="pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          <p className="text-overline text-[var(--color-muted)] mb-4">About</p>
          <h1 className="text-heading-1 text-[var(--color-primary)] mb-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-6 mt-16 pt-10 border-t border-[var(--color-border)]"
        >
          <div>
            <p className="text-overline text-[var(--color-muted)] mb-2">Based in</p>
            <p className="text-heading-3 text-[var(--color-primary)]">New Jersey, USA</p>
          </div>
          <div>
            <p className="text-overline text-[var(--color-muted)] mb-2">Currently</p>
